<template>
  <q-page class="q-pa-sm">
      <h5>Mesass</h5>
       ...
       <!-- <img src="../assets/mesas.png"> -->
    <div class="row q-col-gutter-lg">
      <div class="col-lg-3 col-md-4 col-xs-12 col-sm-12" v-for="(data,index) in card_data">
        <directory-card class="col-lg-4 fit col-md-4 col-sm-12 col-xs-12" :avatar="data.avatar" :name="data.name"
                        :des="data.des"
                        :email="data.email"
                        :estado="data.estado"></directory-card>
      </div>
    </div>
  </q-page>
</template>
...
export default defineComponent({
  name: "Directory",
  components: {
    DirectoryCard: defineAsyncComponent(() => import('components/cards/MesaItem')),
    FontAwesomeIcon
  },
  setup() {
    return {
